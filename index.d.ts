...
export class IMqttClient {
	...
	on(
		event: 'message',
		cb: (msg: { data: string; data_original:ArrayBuffer; qos: QoS; retain: boolean; topic: string }) => void,
	): void;
	...
	publishBuffer(topic: string, payload: ArrayBuffer, qos: QoS, retain: boolean): void;
