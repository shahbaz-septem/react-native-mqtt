...
public class RCTMqttModule extends ReactContextBaseJavaModule
{
   ...
   @ReactMethod
   public void publishBuffer(@NonNull final String clientRef, @NonNull final String topic,@NonNull final ReadableArray buffer, int qos, boolean retain) 
    { 

        clients.get(clientRef).publishBuffer(topic, buffer, qos, retain); 
    }
    @ReactMethod
